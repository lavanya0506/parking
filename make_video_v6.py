...
OUT    = f"{BASE}/assets/ParkIQ_Demo_Final.mp4"
...
r = subprocess.run([
    ...
    "-vf",vf_bar,"-c:v","libx264","-preset","fast","-crf","17",
...
subprocess.run([
    ...
    "-c:a","aac","-b:a","192k","/tmp/pkv6_audio.aac"
], check=True, capture_output=True)
print("  done ✓")
